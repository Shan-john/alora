        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-8 xl:px-12">
          <div className="text-center mb-16">
            ...
            <p className="font-body text-[#666] text-[15px] max-w-2xl mx-auto">
              We’ve been building our business with a core focus on providing
              exactly what you expect. Contact us for any query.
            </p>
          </div>
              ...
              <div className="flex items-start gap-4 group">
                <div className="w-[54px] h-[54px] rounded-full flex items-center justify-center shrink-0 border border-[#e5e5e5] bg-white group-hover:bg-black transition-colors duration-300">
                  <Mail
                    size={22}
                    strokeWidth={1}
                    className="text-[#222] group-hover:text-white transition-colors duration-300"
                  />
                </div>
                <div className="pt-1">
            ...
            >
              {sent ? (
                <div className="text-center py-16">
                  ...
                  <h3 className="font-display text-[28px] font-normal text-[#222] mb-3">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <h3 className="font-display text-[26px] text-[#222] mb-6 font-normal">
                    Send A Message
                  </h3>
